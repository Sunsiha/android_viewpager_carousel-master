...
//    }
    ...
    public void setData(FragmentManager fragmentManager, ArrayList<ImageModel> imageModelsList, long carouselSlideInterval) {
        this.fragmentManager = fragmentManager;
        this.imageModelsList = imageModelsList;
        this.carouselSlideInterval = carouselSlideInterval;
        this.lastPageIndex = imageModelsList.size() - 1;
        initData();
        initCarousel();
        initCarouselSlide();
    }
    ...
    private void initData() {
        ...
        for (int i = 0; i < imageModelsList.size(); i++) {
            ...
            if (i==0 || i==imageModelsList.size()-1) obj.setVisibility(View.INVISIBLE);
    ...
    private void initCarousel() {
        ...
        ViewPagerCarouselAdapter viewPagerCarouselAdapter = new ViewPagerCarouselAdapter(fragmentManager, imageModelsList);
...
//        final int nCount = imageResourceIds.length;
        final int nCount = imageModelsList.size();
        try {
